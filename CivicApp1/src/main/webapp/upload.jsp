...
<div class="container">
    ...
    <% } else if (snapshotData != null && !snapshotData.trim().isEmpty()) { %>
        <!-- First time (base64 preview) -->
        <img src="<%= snapshotData %>" width="350" alt="Captured Image">

        <form id="uploadForm" action="SaveImageServlet" method="post" enctype="multipart/form-data">
            ...
            <!-- Hidden field sends base64 snapshot -->
            <input type="hidden" name="snapshotData" value="<%= snapshotData %>">
